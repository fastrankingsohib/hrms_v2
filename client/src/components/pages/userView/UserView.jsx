    ...
    return (
        <section className="p-4 component-rendering-transition">
            <h1 className="flex items-center justify-between text-2xl font-semibold">
                {user.username}
                <div className="h-12 max-w-60">
                    <button
                        onClick={toggleEdit}
                        className="h-12 mt-4 primary-button"
                    >
            ...
            <form onSubmit={register} className="w-full mt-10">
                <div className="grid grid-cols-4 gap-4">
                    <div>
                        <label htmlFor="title" className="inline-block p-4 pl-0 font-semibold">Title</label>
                        <select
                    ...
                    <div>
                        <label htmlFor="firstName" className="inline-block p-4 pl-0 font-semibold">First Name</label>
                        <input
                            type="text"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="middleName" className="inline-block p-4 pl-0 font-semibold">Middle Name</label>
                        <input
                            type="text"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="lastName" className="inline-block p-4 pl-0 font-semibold">Last Name</label>
                        <input
                            type="text"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="gender" className="inline-block p-4 pl-0 font-semibold">Gender</label>
                        <select
                            className="primary-input"
                            value={user.gender}
                    ...
                    <div>
                        <label htmlFor="dateOfJoining" className="inline-block p-4 pl-0 font-semibold">Date of Joining</label>
                        <input
                            type="date"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="username" className="inline-block p-4 pl-0 font-semibold">Username</label>
                        <input
                            type="text"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="emailId" className="inline-block p-4 pl-0 font-semibold">Email ID</label>
                        <input
                            type="email"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="mobile" className="inline-block p-4 pl-0 font-semibold">Mobile</label>
                        <input
                            type="tel"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="dateOfBirth" className="inline-block p-4 pl-0 font-semibold">Date of Birth</label>
                        <input
                            type="date"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="reportingTo" className="inline-block p-4 pl-0 font-semibold">Reporting to</label>
                        <select
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="employeeId" className="inline-block p-4 pl-0 font-semibold">Employee ID</label>
                        <input
                            type="text"
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="status" className="inline-block p-4 pl-0 font-semibold">Status</label>
                        <select
                            className="primary-input"
                            value={user.status}
                    ...
                    <div>
                        <label htmlFor="userType" className="inline-block p-4 pl-0 font-semibold">User Type</label>
                        <select
                            className="primary-input"
                            value={user.userType}
                    ...
                    <div>
                        <label htmlFor="designation" className="inline-block p-4 pl-0 font-semibold">Designation</label>
                        <select
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="department" className="inline-block p-4 pl-0 font-semibold">Department</label>
                        <select
                            className="primary-input"
                    ...
                    <div>
                        <label htmlFor="role" className="inline-block p-4 pl-0 font-semibold">Role</label>
                        <select
                            className="primary-input"
                            value={user.role}
                ...
                <div className="flex items-center justify-end mt-10">
                    <div className="w-1/4 pl-4">
                        <button className="justify-center primary-button" type="submit" disabled={!isEditing}>Create User</button>
                    </div>
                </div>
            </form>
        </section>
