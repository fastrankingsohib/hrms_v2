    ...
    return (
        <div className='p-4 bg-gray-100 h-full max-h-full overflow-auto'>
            ...
            <div className='bg-white p-4 pt-8 mt-4 shadow-xl rounded-[8px]'>
                <div className='flex items-center gap-4'>
                    ...
                    <div className='flex gap-4'>
                        <button
                            className={`h-[40px] rounded-[8px] w-32 ${jobDetails.job_type === 'Full Time' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                            onClick={() => {
                        ...
                        <button
                            className={`h-[40px] rounded-[8px] w-32 ${jobDetails.job_type === 'Part Time' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                            onClick={() => setJobDetails((values) => ({ ...values, job_type: 'Part Time' }))}>
                            Part Time
                        </button>
                        <button
                            className={`h-[40px] rounded-[8px] w-32 ${jobDetails.job_type === 'Internship' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                ...
                <div className='grid grid-cols-2 gap-4'>
                    <div>
                        ...
                        <div className='flex gap-4'>
                            <button
                                className={`h-[40px] w-32 rounded-[8px] ${jobDetails.job_shift === 'Morning' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                                onClick={() => setJobDetails((values) => ({ ...values, job_shift: 'Morning' }))}>
                                Morning
                            </button>
                            <button
                                className={`h-[40px] w-32 rounded-[8px] ${jobDetails.job_shift === 'Afternoon' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                                onClick={() => setJobDetails((values) => ({ ...values, job_shift: 'Afternoon' }))}>
                                Afternoon
                            </button>
                            <button
                                className={`h-[40px] w-32 rounded-[8px] ${jobDetails.job_shift === 'Night' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
            ...
            <div className='bg-white p-4 mt-4 select-none shadow-xl rounded-[8px]'>
                ...
                <div className='flex gap-4'>
                    <button
                        className={`h-[40px] rounded-[8px] px-4 min-w-32 ${jobDetails.experience === 'Any' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                        onClick={() => setJobDetails((values) => ({ ...values, experience: 'Any' }))}>
                        Any
                    </button>
                    <button
                        className={`h-[40px] rounded-[8px] px-4 min-w-32 ${jobDetails.experience === 'Freshers Only' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
                        onClick={() => setJobDetails((values) => ({ ...values, experience: 'Freshers Only' }))}>
                        Freshers Only
                    </button>
                    <button
                        className={`h-[40px] rounded-[8px] px-4 min-w-32 ${jobDetails.experience === 'Experienced Only' ? 'bg-indigo-900 text-white' : 'bg-gray-100'}`}
            ...
            <div className='py-4 text-right mt-10'>
                ...
                <button className='p-2.5 bg-indigo-900 rounded-[8px] text-white px-10'
                ...
                <div className="fixed z-30 inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white w-[30em] p-10 rounded-lg shadow-lg">
                        ...
                        <div className="flex justify-end">
                            ...
                            >Cancel</button>
                            <button
                                className="p-2.5 px-8 bg-indigo-900 text-white rounded"
                                onClick={() => {
                                    saveScheduleJob();
                                    createJobPost();
                                }}
